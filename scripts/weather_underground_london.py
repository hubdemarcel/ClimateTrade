#!/usr/bin/env python3
"""
Weather Underground Data Fetching for London Weather Data

This script integrates Weather Underground API to provide current and historical
weather data for London, with CSV output and comprehensive error handling.
...
Usage:
    python weather_underground_london.py --apikey YOUR_API_KEY [options]
"""
...
LONDON_STATION_ID = "EGLC"  # London City Airport station for Polymarket resolution
...
class WeatherUndergroundClient:
    ...
    def get_current_conditions(self, station_id: str = LONDON_STATION_ID) -> Dict:
    ...
    def get_hourly_forecast(self, latitude: float = LONDON_COORDINATES['latitude'],
    ...
    def get_daily_forecast(self, latitude: float = LONDON_COORDINATES['latitude'],
                          longitude: float = LONDON_COORDINATES['longitude'],
    ...
    def get_historical_data(self, station_id: str = LONDON_STATION_ID,
...
def format_weather_output(data: Dict) -> str:
    ...
    output = f"""
🌤️  London Weather Report (Weather Underground)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def main():
    parser = argparse.ArgumentParser(
        description="Retrieve weather data for London using Weather Underground API"
    )
    parser.add_argument(
        "-k", "--apikey",
        required=True,
    ...
    parser.add_argument(
        "--station-id",
        default=LONDON_STATION_ID,
        help=f"Weather station ID (default: {LONDON_STATION_ID})"
    )
    parser.add_argument(
        "--current",
        action='store_true',
    ...
    try:
        ...
        if args.current:
            ...
            if args.json:
                ...
                print("📅 London Daily Weather Forecast (Weather Underground)")
                print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                for day in daily:
            ...
            if args.json:
                ...
                print("🕒 London Hourly Weather Forecast (Weather Underground)")
                print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
